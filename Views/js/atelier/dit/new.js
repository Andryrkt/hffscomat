...
const idMaterielInput = document.querySelector("#dit_idMateriel");
const numParcInput = document.querySelector("#dit_numParc");
...
const demandeDevisInput = document.querySelector("#dit_demandeDevis");
