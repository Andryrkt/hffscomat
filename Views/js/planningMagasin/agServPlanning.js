...
const config = {
  elements: {
    agenceDebiteurInput: "#planning_magasin_search_agenceDebite",
    serviceDebiteurInput: "#planning_magasin_search_serviceDebite",
    selectAllCheckbox: "#planning_magasin_search_selectAll",
    searchForm: "#planning_magasin_search_form", // Ajout de l'ID du formulaire de recherche
  },
  urls: {
    serviceFetch: (agenceDebiteur) =>
      `api/serviceDebiteurPlanningMagasin-fetch/${agenceDebiteur}`,
  },
};
...
function clearServiceCheckboxes() {
  const serviceCheckboxes = document.querySelectorAll(
    'input[name="planning_magasin_search[serviceDebite][]"]'
  );
...
function ensureSelectAllCheckbox() {
  ...
  if (!selectAllCheckbox) {
    ...
    selectAllCheckbox.id = "planning_magasin_search_selectAll";
...
function addServiceCheckboxes(services) {
  services.forEach((service, index) => {
    ...
    checkbox.name = "planning_magasin_search[serviceDebite][]";
