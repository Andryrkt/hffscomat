...
const config = {
  elements: {
    agenceDebiteurInput: "#planning_atelier_search_agenceDebite",
    serviceDebiteurInput: "#planning_atelier_search_serviceDebite",
    selectAllCheckbox: "#planning_atelier_search_selectAll",
    searchForm: "#planning_atelier_search_form", // Ajout de l'ID du formulaire de recherche
  },
  urls: {
...
function clearServiceCheckboxes() {
  const serviceCheckboxes = document.querySelectorAll(
    'input[name="planning_atelier_search[serviceDebite][]"]'
  );
...
function ensureSelectAllCheckbox() {
  ...
  if (!selectAllCheckbox) {
    ...
    selectAllCheckbox.id = "planning_atelier_search_selectAll";
...
function addServiceCheckboxes(services) {
  services.forEach((service, index) => {
    ...
    checkbox.name = "planning_atelier_search[serviceDebite][]";
