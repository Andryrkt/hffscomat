...
document.addEventListener("DOMContentLoaded", function () {
  const fileInput1 = document.querySelector("#verification_prix_pieceJoint01");
  ...
  const fileInput2 = document.querySelector("#verification_prix_pieceJoint2");
  if (fileInput2) initializeFileHandlersMultiple("2", fileInput2);

  const fileInput3 = document.querySelector(
    "#verification_prix_pieceJointExcel",
  );
  ...
  if (form) {
    form.addEventListener("submit", function (e) {
      ...
      const fileInput1 = document.querySelector(
        "#verification_prix_pieceJoint01",
      );
