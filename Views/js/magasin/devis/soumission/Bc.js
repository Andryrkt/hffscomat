...
document.addEventListener("DOMContentLoaded", function () {
  const fileInput1 = document.querySelector("#bc_pieceJoint01");
  if (fileInput1) {
    initializeFileHandlersNouveau("1", fileInput1);
  }

  const fileInput2 = document.querySelector("#bc_pieceJoint2");
  if (fileInput2) {
 ...
 *=========================================================*/
const montantBcInput = document.querySelector("#bc_montantBc");
