...
class DitMapper
{
    ...
    {
        return array_map(function ($ditInformations) use ($dto) {

            return [
                'numeroDit' => $dto->numeroDit,
                'numeroOr' => $dto->numeroOr,
                'numeroItv' => $ditInformations['NUMERO_ITV'],
                'dateSoumission' => $dto->dateSoumission,
                'heureSoumission' => $dto->heureSoumission,
                'nombreLigneItv' => $ditInformations['NOMBRE_LIGNE'],
                'montantItv' => $ditInformations['MONTANT_ITV'],
                'numeroVersion' => $dto->numeroVersion,
                'montantPiece' => $ditInformations['MONTANT_PIECE'],
                'montantMo' => $ditInformations['MONTANT_MO'],
                'montantAchatLocaux' => $ditInformations['MONTANT_ACHATS_LOCAUX'],
                'montantFraisDivers' => $ditInformations['MONTANT_DIVERS'],
                'montantLubrifiants' => $ditInformations['MONTANT_LUBRIFIANTS'],
                'libellelItv' => $ditInformations['LIBELLE_ITV'],
