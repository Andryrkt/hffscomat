...
class DwDaReapproP
{
    ...
    /**
     * @ORM\Column(type="integer", name="id_da_reap_p", nullable=true)
     */
    private $idDaReapproP;

    /**
     * @ORM\Column(type="string", length=50, name="numero_da_reap_p", nullable=true)
     */
    private $numeroDaReapproP;

    /**
     * @ORM\Column(type="string", length=50, name="statut_da_reap_p", nullable=true)
     */
    private $statutDaReapproP;
     ...
     */
    public function getIdDaReapproP()
    {
        return $this->idDaReapproP;
    }
     ...
     * @return  self
     */
    public function setIdDaReapproP($idDaReapproP)
    {
        $this->idDaReapproP = $idDaReapproP;
     ...
     */
    public function getNumeroDaReapproP()
    {
        return $this->numeroDaReapproP;
    }
     ...
     * @return  self
     */
    public function setNumeroDaReapproP($numeroDaReapproP)
    {
        $this->numeroDaReapproP = $numeroDaReapproP;
     ...
     */
    public function getStatutDaReapproP()
    {
        return $this->statutDaReapproP;
    }
     ...
     * @return  self
     */
    public function setStatutDaReapproP($statutDaReapproP)
    {
        $this->statutDaReapproP = $statutDaReapproP;
