...
/**
 * @ORM\Entity(repositoryClass=DwBonDeCaisseRepository::class)
 * @ORM\Table(name="DW_Bon_de_caisse")
 */
class DwBonDeCaisse
{
    /**
    ...
    /**
     * @ORM\Column(type="integer", name="id_bcs", nullable=true)
     */
    private $idBcs;

    /**
     * @ORM\Column(type="string", length=50, name="numero_bcs", nullable=true)
     */
    private $numeroBcs;

    /**
     * @ORM\Column(type="string", length=50, name="statut_bcs", nullable=true)
     */
    private $statutBcs;
    ...
    /**
     * Get the value of idBcs
     */
    public function getIdBcs()
    {
        return $this->idBcs;
    }

    /**
     * Set the value of idBcs
     *
     * @return  self
     */
    public function setIdBcs($idBcs)
    {
        $this->idBcs = $idBcs;
    ...
    /**
     * Get the value of numeroBcs
     */
    public function getNumeroBcs()
    {
        return $this->numeroBcs;
    }

    /**
     * Set the value of numeroBcs
     *
     * @return  self
     */
    public function setNumeroBcs($numeroBcs)
    {
        $this->numeroBcs = $numeroBcs;

        return $this;
    }

    /**
     * Get the value of statutBcs
     */
    public function getStatutBcs()
    {
        return $this->statutBcs;
    }

    /**
     * Set the value of statutBcs
     *
     * @return  self
     */
    public function setStatutBcs($statutBcs)
    {
        $this->statutBcs = $statutBcs;
