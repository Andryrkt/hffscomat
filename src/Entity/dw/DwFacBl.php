...
/**
 * @ORM\Entity(repositoryClass=DwFactureBonLivraisonRepository::class)
 * @ORM\Table(name="DW_FAC_BL")
 */
class DwFacBl
{
    /**
    ...
    /**
     * @ORM\Column(type="integer", name="id_fac_bl", nullable=true)
     */
    private $idFacBl;
    ...
    /**
     * Get the value of idFacBl
     */
    public function getIdFacBl()
    {
        return $this->idFacBl;
    }

    /**
     * Set the value of idFacBl
     *
     * @return  self
     */
