...
class GeneratePdfBcNeg extends GeneratePdf
{
    /**
     ...
     * @return void
     */
    public function generer(BcDto $dto, string $filePath): void
    {
        $pdf = new HeaderPdf($dto->utilisateur . ' - ' . $dto->userMail);
        ...
        $pdf->SetFont($font2, '', 10);
        $pdf->Cell(90, 10, ': ' . number_format($dto->montantDevis, 2, ',', '.'), 0, 0, 'L');
        $pdf->SetFont($font2, 'B', 10);
