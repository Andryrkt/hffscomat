...
class MontantPdfService
{
    ...
    public function montantpdf(array $devisSoumisAvant)
    {
    ...
    public function recuperationAvantApresVente(array $OrSoumisAvantMax, array $OrSoumisAvant)
    {
    ...
    private function recuperationAvantApresForfait(array $OrSoumisAvantMax, array $OrSoumisAvant)
    {
    ...
    private function objetsManquantsParNumero(array $tableauA, array $tableauB)
    {
        ...
        foreach ($tableauB as $objetB) {
            ...
            if (!$trouve) {
                $numeroItvExist = $objetB->numeroItv === 0 ? $objetA->numeroItv : $objetB->numeroItv;
                // Créer un nouvel objet avec uniquement le numero et les autres propriétés à null ou 0
                $nouvelObjet = new DitDevisSoumisAValidationDto();
                $nouvelObjet->numeroItv = $numeroItvExist;
    ...
    private function affectationStatut(array $recapAvantApres)
    {
    ...
    private function affectationStatutVenteRevient(array $recapAvantApres)
    {
        $nombreStatutNouvEtSupp = [
            'nbrNouv' => 0,
            'nbrSupp' => 0,
     ...
     * ceci se mettre sur le footer du tableau
     *
     * @param array $recapAvantApresVenteVariation
     * @return array
     */
     ...
     * ceci se mettre sur le footer du tableau
     *
     * @param array $sommeTotalAvApVente
     * @param array $sommeTotalAvApForfait
     * @return array
     */
    ...
    private function recapitulationVente(array $orSoumisValidataion)
    {
        $recapOr = [];
    ...
    private function recapitulationVenteRevient(array $orSoumisValidataion)
    {
        $recapOr = [];
