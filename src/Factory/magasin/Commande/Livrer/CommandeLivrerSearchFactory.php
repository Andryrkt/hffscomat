...
namespace App\Factory\magasin\Commande\Livrer;
...
class CommandeLivrerSearchFactory
{
    ...
    public function initialisationSearch(): CommandeLivrerSearchDto
    {
        $agenceUser = "''";
        ...
        $dto = new CommandeLivrerSearchDto();
